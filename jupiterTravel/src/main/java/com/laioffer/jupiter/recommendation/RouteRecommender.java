...
public class RouteRecommender {
    ...
    private List<Place> findBestRoute(List<Place> selectedLocations) throws RecommendationException {
        List<Place> recommendedRoute = new ArrayList<>();
...
//            }
//            for (Item item : items) {
//                if (recommendedRoute.size() == DEFAULT_TOTAL_RECOMMENDATION_LIMIT) {
//                    break outerloop;
//                }
//                recommendedRoute.add(item);
//            }
//        }
